<?php
// ==========================================
// OBAT ANTI-CACHE & LAYAR PUTIH TINGKAT DEWA
// ==========================================
...
// --- LOGIKA BACA COOKIE KTP (DARI DASHBOARD LU BIAR GAK BLANK/LOGOUT) ---
$akses_diberikan = false;

if (isset($_SESSION['logged_in'])) {
    $akses_diberikan = true;
} elseif (isset($_COOKIE['ingat_nomor_induk']) && isset($_COOKIE['token_aman'])) {
...
// JIKA TETAP GAK ADA AKSES, LEMPAR KE LOGIN
if (!$akses_diberikan) {
