...
<head>
    ...
    <style>
        ...
        /* =========================================================
           🔥 FIX AMAN: SCROLLBAR ILANG, WALLPAPER TETEP JOSS 🔥
        ========================================================= */
        ...
        html, body {
            scrollbar-width: none !important; /* Penangkal buat Firefox */
            -ms-overflow-style: none !important; /* Penangkal buat Edge */
        }
        ...
        .fc-daygrid-day-events::-webkit-scrollbar { width: 4px; display: block !important; } /* Scrollbar kecil dalem event kalender tetep ada biar aman */
